                        ...
                        <div class="exam_list_content">
                            <table stripe>
                                ...
                                <tr v-for="o in list" :key="o">
                                    ...
                                    <td>{{o.duration}}</td>
                                    <td>
                                        <router-link :to="'/evaluation/details?exam_id='+o.exam_id" class="answer_link"  v-if="answered_list[o.exam_id]">
                                            <span>查看</span>
                                        </router-link>
                                        <router-link :to="'/evaluation/details?exam_id='+o.exam_id" class="answer_link"  v-else-if="o.status==='启用'">
                                            <span>答题</span>
                                        </router-link>
                                    </td>
                                </tr>
