				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 天气类型 -->
							<div><span>天气类型</span></div>
							<table_weather_type v-if="$check_action('/weather_type/table','get')"></table_weather_type>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_weather_type from "../../components/diy/table_weather_type.vue";
	export default {
		data() {
			return {
			};
