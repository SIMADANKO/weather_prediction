<template>
	<el-main class="bg table_wrap">
		...
		<el-table border :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" stripe>
			...
			<el-table-column fixed prop="comment_desc" label="评语" min-width="120">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" width="150">
				<template slot-scope="scope">
					<router-link v-if="scope.row['comment_state']===1" class="el-button el-button--small is-plain el-button--primary"
