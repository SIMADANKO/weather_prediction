				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 降雨量数据 -->
							<div><span>降雨量数据</span></div>
							<view_rainfall_data v-if="$check_action('/rainfall_data/view','get')"></view_rainfall_data>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_rainfall_data from "../../components/diy/view_rainfall_data.vue";
	export default {
		data() {
			return {
			};
