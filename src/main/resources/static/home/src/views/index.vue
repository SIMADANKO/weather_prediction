		...
		<div class="warp article_s">
		    ...
		    <div class="container">
		        <div class="row">
					...
					<!-- 推荐天气信息模块(开始) -->
		<div class="ins warp model1" v-if="$check_action('/weather_information/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/weather_information/list" class="ins_more more">
		                ...
		                <!-- 天气信息推荐列表组件 -->
						<div class="list_weather_information_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_weather_information :list="list_weather_information" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
	...
	export default {
		...
		methods: {
			...
			get_weather_information() {
				let url = "~/api/weather_information/get_list?";
														let param = {
									"page": 1,
					"size": 12
				}
					...
					if (json.result) {
						this.list_weather_information = json.result.list;
					}
				})
			},
		...
		computed: {
					    list_table_rainfall_data() {
		        var list = this.list_weather_information;
		        var list_table = [];
		        for (let i = 0; i < list.length; i++) {
		            list_table[i] = {};
		            this.vm_arr_weather_information.map((o) => {
		                // 第二个中括号是对象的属性
