            ...
            <div class="col-12">
              <div class="my_header">
                ...
                <div class="conton-top">
                  <router-link to="/">
                  <div class="logo">韶关市降雨量数据分析与可视化系统</div>
                  </router-link>
                    ...
                    <li class="nav_li">
                      <router-link to="/" class="nav_a">
                        首页
					  					   ...
					  					   <li class="nav_li" v-if="$check_exam('/evaluation/list','answers')">
						 <router-link to="/evaluation/list" class="nav_a">
							 {{$page_title("/evaluation/list") || 调查问卷}}
						 </router-link>
					   </li>
