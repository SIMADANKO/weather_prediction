			...
			<el-row class="row_e">
				...
				<el-col v-for="(o, i) in question_list" :xs="24" :sm="24" :lg="24" class="el_form_item_warp">
					...
					<div class="title_margin" v-else-if="o.type === '多选题'">
						{{ o.question_order + '.多选题333：' + o.title }}
					</div>
			...
			<el-col :xs="24" :sm="24" :lg="24" class="el_form_btn_warp">
				<el-form-item>
					<el-col :xs="24" :sm="24" :lg="12" class="el_form_btn el_form_btn_1">
						<el-button v-if="!if_scored" style="width: 100%; float: left;" type="primary"
							@click="submit()">提交
						</el-button>
					</el-col>
...
export default {
	...
	methods: {
		...
		submit_main() {
			...
			this.$post(url, Object.assign(_this.form, { comment_state: 1 }), function (json, status) {
