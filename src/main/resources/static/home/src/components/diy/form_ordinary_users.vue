<template>
	<div class="diy_form">
			<b-form-group v-if="$check_register_field('add','user_name','/ordinary_users/view')" id="user_name" label="用户姓名" label-for="user_name">
			<b-form-input id="user_name" v-model="form['user_name']" type="text" placeholder="请输入用户姓名" trim ></b-form-input>
		</b-form-group>
				<b-form-group v-if="$check_register_field('add','user_phone_number','/ordinary_users/view')" id="user_phone_number" label="用户电话" label-for="user_phone_number">
			<b-form-input id="user_phone_number" v-model="form['user_phone_number']" type="tel" placeholder="请输入用户电话" trim></b-form-input>
		</b-form-group>
		</div>
</template>
